...
use Level\QuickOrder\Api\Model\QuickOrderRepositoryInterface as OrderRepository;
...
class InlineEdit extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Level\QuickOrder\Api\Model\QuickOrderRepositoryInterface
     */
    ...
    public function execute()
    {
        ...
        foreach (array_keys($postItems) as $pageId) {
            /** @var \Level\QuickOrder\Model\QuickOrder $page */
     ...
     * @return void
     */
    protected function validatePost(array $pageData, \Level\QuickOrder\Model\QuickOrder $page, &$error, array &$messages)
    {
     ...
     * @return $this
     */
    public function setCmsPageData(\Level\QuickOrder\Model\QuickOrder $page, array $extendedPageData, array $pageData)
    {
